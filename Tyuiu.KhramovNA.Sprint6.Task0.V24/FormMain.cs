...
using Tyuiu.KhramovNA.Sprint6.Task0.V24.Lib;
...
namespace Tyuiu.KhramovNA.Sprint6.Task0.V24
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 0 выполнил студент группы АСОиУБ-23-3 Храмов Николай Андреевич", "Сообщение");
        }

        private void pictureBoxFormula_SIA_Click(object sender, EventArgs e)
        {
